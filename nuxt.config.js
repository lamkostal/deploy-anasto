...
module.exports = {
  ...
  */
  head: {
    title: "ΓΙΩΡΓΟΣ ΑΝΑΣΤΟΠΟΥΛΟΣ | ΟΡΘΟΠΕΔΙΚΟΣ - ΧΕΙΡΟΥΡΓΟΣ, τεχνικές ελαχίστης χειρουργικής παρέμβασης (MIS)",
    meta: [
      { charset: 'utf-8' },
      ...
      {property:"og:title",content:"ΓΙΩΡΓΟΣ ΑΝΑΣΤΟΠΟΥΛΟΣ | ΟΡΘΟΠΕΔΙΚΟΣ - ΧΕΙΡΟΥΡΓΟΣ, τεχνικές ελαχίστης χειρουργικής παρέμβασης (MIS)"},
      ...
      {name:"twitter:title",content:"ΓΙΩΡΓΟΣ ΑΝΑΣΤΟΠΟΥΛΟΣ | ΟΡΘΟΠΕΔΙΚΟΣ - ΧΕΙΡΟΥΡΓΟΣ, τεχνικές ελαχίστης χειρουργικής παρέμβασης (MIS)"},
      {name:"twitter:site",content:"ΓΙΩΡΓΟΣ ΑΝΑΣΤΟΠΟΥΛΟΣ | ΟΡΘΟΠΕΔΙΚΟΣ - ΧΕΙΡΟΥΡΓΟΣ, τεχνικές ελαχίστης χειρουργικής παρέμβασης (MIS)"},
