<template>
  <section class="section footer has-shadow has-background-light">
    <div class="container">
      ...
      <div class="columns">
        ...
        <div class="column is-one-third is-desktop logocol is-narrow">
          <!-- AddToAny BEGIN -->
          <div class="columns">
            <div class="sharecont column has-text-right-desktop">
